...
import org.aquapackrobotics.sw8s.comms.control.WatchDogStatus;
...
public class ControlBoardListenerTest {
    ...
    public void testAcknowledgeMessage() {
        ...
        for (short id = 1; id <= 20; id++) {
            byte idLowByte = (byte) (id & 0x00FF);
            byte idHighByte = (byte) ((id & 0xFF00) >> 8);
            // Expected message retrieved from MessageStack should be data containing the
            // idLowByte and idHighByte
