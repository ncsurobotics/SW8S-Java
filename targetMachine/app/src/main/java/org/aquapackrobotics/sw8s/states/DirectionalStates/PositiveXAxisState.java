...
public class PositiveXAxisState extends State {
    ...
    public PositiveXAxisState(ControlBoardThreadManager manager) {
        super(manager);
    }
    ...
    public void onEnter() throws ExecutionException, InterruptedException {
        ...
        manager.setLocalSpeeds(0.5, 0, 0, 0, 0, 0);
    ...
    public State nextState() {
        return new NegativeXAxisState(manager);
    }
}
